...
# Catch Up True In Case Someone needed to change the start date to a previous date a dag should be associated to it. By default nothing changes since we are using datetime.now() running a day by day tweet scrapping
dag = DAG(
    'ScrapersSentimentAnalysisDaily-DAG',
